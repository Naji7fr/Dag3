...
@section('content')
<section class="behandeling-overzicht">
    ...
    <div class="card search-card behandeling-filter-card">
        <form method="get" action="{{ route('behandelingen.index') }}" id="behandeling-filter-form" class="behandeling-filter-form">
            <div class="search-row">
                <div class="behandeling-select-group">
                    ...
                    <select id="behandeling" name="behandeling" class="custom-dropdown">
                        ...
                        @endforeach
                        <option value="Overige" @if($selectedBehandeling === 'Overige') selected @endif>Overige</option>
                    </select>
                </div>
    ...
    <div class="card table-card behandeling-table-card">
