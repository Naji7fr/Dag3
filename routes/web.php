...
Route::middleware('auth')->group(function (): void {
    ...
    Route::middleware('eigenaar')->group(function (): void {
        ...
        Route::get('/behandelingen/product/{id}', [BehandelingController::class, 'showProduct'])->name('behandelingen.product-detail');
        Route::get('/behandelingen/product/{id}/wijzigen', [BehandelingController::class, 'editProduct'])->name('behandelingen.edit-product');
        Route::put('/behandelingen/product/{id}', [BehandelingController::class, 'updateProduct'])->name('behandelingen.update-product');
    });
});
